...
const MOTION_ANIMATIONS = {
  groove: {
    root: "guardian-groove-v2",
    torso: "torso-groove-v2",
    hip: "hip-groove-v2",
    head: "head-groove-v2",
    leftLeg: "leg-l-groove-v2",
    rightLeg: "leg-r-groove-v2",
    leftArm: "arm-l-groove-v2",
    rightArm: "arm-r-groove-v2",
  },
  moonwalk: {
    root: "guardian-moonwalk-v2",
    torso: "torso-moonwalk-v2",
    hip: "hip-moonwalk-v2",
    head: "head-moonwalk-v2",
    leftLeg: "leg-l-moonwalk-v2",
    rightLeg: "leg-r-moonwalk-v2",
    leftArm: "arm-l-moonwalk-v2",
    rightArm: "arm-r-moonwalk-v2",
  },
  spin: {
    root: "guardian-spin-v2",
    torso: "torso-spin-v2",
    hip: "hip-spin-v2",
    head: "head-spin-v2",
    leftLeg: "leg-l-spin-v2",
    rightLeg: "leg-r-spin-v2",
    leftArm: "arm-l-spin-v2",
    rightArm: "arm-r-spin-v2",
  },
  dip: {
    root: "guardian-dip-v2",
    torso: "torso-dip-v2",
    hip: "hip-dip-v2",
    head: "head-dip-v2",
    leftLeg: "leg-l-dip-v2",
    rightLeg: "leg-r-dip-v2",
    leftArm: "arm-l-dip-v2",
    rightArm: "arm-r-dip-v2",
  },
} as const;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at center, oklch(1 0 0 / 0.06), transparent 70%)",
        }}
      />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 38%, oklch(1 0 0 / 0.16), transparent 65%)",
        }}
      />
      ...
      >
        ...
        <g
          style={{
            transformOrigin: "75px 195px",
            animation: motion ? `${motion.hip} ${EMOTE_MS[emote]}ms ease-in-out infinite` : "none",
          }}
        >
          {/* Left leg */}
          <g
            style={{
              transformOrigin: "58px 198px",
              animation: motion
                ? `${motion.leftLeg} ${EMOTE_MS[emote]}ms ease-in-out infinite`
                : "none",
            }}
          >
          ...
          <g
            style={{
              transformOrigin: "92px 198px",
              animation: motion
                ? `${motion.rightLeg} ${EMOTE_MS[emote]}ms ease-in-out infinite`
                : "none",
            }}
          >
        ...
        <g
          style={{
            ...
            animation: motion
              ? `${motion.torso} ${EMOTE_MS[emote]}ms ease-in-out infinite`
              : "none",
          }}
        >
          ...
          <g transform="translate(63,156) scale(0.58)" opacity="0.92">
            <path
              d="M10 2 18 5.5v6c0 4.5-3 8-8 10C5 21.5 2 18 2 13.5V5.5Z"
            ...
            <path
              d="M10 4v2M10 16v2M4 11h2M14 11h2"
        ...
        <g
          style={{
            ...
            animation: motion ? `${motion.head} ${EMOTE_MS[emote]}ms ease-in-out infinite` : "none",
          }}
        >
          ...
          <circle
            ...
            style={{
              ...
              filter: "drop-shadow(0 0 5px oklch(1 0 0 / 0.9))",
            }}
          />
          {/* Ear vents */}
      ...
      <div
        className="guardian-logo-mark pointer-events-none absolute inset-0 grid place-items-center"
        aria-hidden="true"
      >
      ...
      <form onSubmit={mode === "signin" ? handleSignIn : handleSignUp} className="space-y-3">
        {mode === "signup" && (
          <div className="space-y-1">
            <Label htmlFor="ac-name" className="text-xs">
              Full name
            </Label>
            <Input
              id="ac-name"
        ...
        <div className="space-y-1">
          <Label htmlFor="ac-pw" className="text-xs">
            Password
          </Label>
          <div className="relative">
            <Input
